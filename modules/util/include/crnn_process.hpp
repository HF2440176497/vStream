...
inline const std::vector<int> rec_image_shape{3, 32, 320};

inline cv::Mat CrnnResizeImg(cv::Mat img, float wh_ratio, int rec_image_height) {
  int imgC, imgH, imgW;
...
inline cv::Mat GetRotateCropImage(cv::Mat srcimage,
